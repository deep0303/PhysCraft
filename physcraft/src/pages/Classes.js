...
const ResourceCard = ({ resource }) => {
  ...
  const handleDownload = async (resourceTitle) => {
    try {
      // Configure the correct path to your PDF files
      const url = `/pdfs/${resourceTitle}`;
      ...
      setDownloadError("Failed to download resource. Please try again.");
    }
  };
...
const PhysCraftAcademy = () => {
  ...
  // Updated resources array with correct file names
  const resources = [
    {
      title: "F=ma Test.pdf",
    ...
    {
      title: "ap-physics-1-equations-sheet.pdf",
      description: "Complete formula reference for AP Physics 1 & 2",
      type: "Quick Reference"
    },
    {
      title: "SHM_Olympiad_problems.pdf",
